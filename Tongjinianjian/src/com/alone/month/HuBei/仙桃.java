...
public class 仙桃 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 2; i++) {
			number = i + "";
			url = "http://www.xiantao.gov.cn/zwgk/jcxxgk/tjxx2017/floatlist_4679_1.shtml";
			charset = "utf-8";
			selector = "#content tr";
			selector02 = ".am-article-bd abc";
			selector03 = ".news-cont p";
				...
				if (link != null && !"".equals(link)) {
					 ...
					 */
						 ...
						 */
							...
							// 获取图片信息
							Elements imgElements = htmlDoc.select(selector03).select("img[src] oo");
