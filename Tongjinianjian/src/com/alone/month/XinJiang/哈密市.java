...
public class 哈密市 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 55; i > 7; i--) {
			number = i + "";
			url = "http://www.hami.gov.cn/xxgk/xxgknr/jjtjcx/tjsj/"+number+".htm";
			charset = "utf-8";
			selector = ".about_right_font ul li";
			selector02 = ".am-article-bd abc";
			selector03 = "div#vsb_newscontent";

			filepath = "G:\\数据\\新疆\\地级市\\哈密\\";
			...
			for (Element element : elements) {
				...
				// 获取名称
				String name = element.select("a:not(span)").text().substring(12);
				// 创建文件夹--发布时间
