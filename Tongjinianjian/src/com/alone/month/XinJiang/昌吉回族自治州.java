...
public class 昌吉回族自治州 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 5; i < 13; i++) {
			number = i + "";
			url = "http://www.cj.gov.cn/info/iList.jsp?cat_id=25405&cur_page="+number;
			charset = "utf-8";
			selector = ".commonList_dot.news_list li";
			selector02 = ".am-article-bd abc";
//			selector03 = "#info_content > table > tbody";
			selector03="#info_content";
			filepath = "G:\\数据\\新疆\\地级市\\昌吉回族自治州\\经济数据解读\\";
						 ...
						 */
							...
							if (imgElements.size() != 0 && textElements.size() != 0) {
								...
								for (int j = 0; j < imgElements.size(); j++) {
									...
									if (imgLink.startsWith("file")||imgLink.endsWith("W020170527340676987330.jpg")||imgLink.endsWith("2011年乌市公报_files/image001.jpg"))
										continue;
									imgList.add(imgLink);
