...
public class 乌鲁木齐 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 7; i++) {
			number = i + "";
			url = "http://www.urumqi.gov.cn/info/iList.jsp?cat_id=15405&cur_page="+number;
			charset = "utf-8";
			selector = ".commonList_dot.am-padding-top-sm.am-padding-bottom-0.commonList_dot_Listnews li";
			selector02 = ".am-article-bd abc";
			selector03 = ".am-article-bd";

			filepath = "G:\\数据\\新疆\\地级市\\乌鲁木齐\\11\\";
