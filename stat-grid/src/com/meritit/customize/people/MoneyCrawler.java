...
public class MoneyCrawler {

	static Logger logger = Logger.getLogger(MoneyCrawler.class);
	...
	public List crawlerHandler(String code, String cityName) {
		String initUrl = "http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=fsnd&rowcode=zb&colcode=sj&wds=[{\"wdcode\":\"reg\",\"valuecode\":\""
				+ code
				+ "\"}]&dfwds=[{\"wdcode\":\"zb\",\"valuecode\":\"A0801\"},{\"wdcode\":\"sj\",\"valuecode\":\"LAST5\"}]&k1=1513230219640";
		...
		//http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=fsnd&rowcode=zb&colcode=sj&wds=[{"wdcode":"reg","valuecode":"110000"}]&dfwds=[{"wdcode":"zb","valuecode":"A0801"}]&k1=1514186007349
...
/*			if (ss.startsWith("zb.A050102") && (ss.endsWith(".2011") || ss.endsWith(".2012") || ss.endsWith(".2013")
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		MoneyCrawler peopleCountCrawler = new MoneyCrawler();
		...
		// 导出数据到Excel中
		// 表头
		String[] headers = { "省份", "年份", "地方财政一般预算收入(亿元)" };
		String[] Col = { "省份", "年份", "地方财政一般预算收入(亿元)"};
