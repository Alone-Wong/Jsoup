...
public class 潜江 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i < 2; i++) {
            number = i + "";
            url = "http://www.hbqj.gov.cn/tjtjyb2017/";
            charset = "utf-8";
            selector = ".font14 li a[href]";
            selector02 = ".am-article-bd abc";
            selector03 = ".detail-article.font16 img[src]";

            filepath = "G:\\数据\\湖北\\地级市\\潜江市\\";
                ...
                if (link != null && !"".equals(link)) {
                     ...
                     */
                         ...
                         */
                            ...
                            // 获取文本信息
                            Elements textElements = htmlDoc.select(selector03).select("dsf");
                            // 获取图片信息
                            Elements imgElements = htmlDoc.select(selector03);
