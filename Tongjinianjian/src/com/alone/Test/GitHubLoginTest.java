...
public class GitHubLoginTest {
    ...
    public static String userName = "wangzhilong228@163.com";
    public static String passWord = "wangzhilong000";

    public static void main(String[] args) throws Exception {

        simulateLogin("wangzhilong228@163.com", "wangzhilong000"); // 模拟登陆github的用户名和密码
