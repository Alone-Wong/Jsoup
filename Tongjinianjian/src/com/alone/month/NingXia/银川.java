...
public class 银川 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 2; i++) {
			number = i + "";
			url = "http://www.yctjj.gov.cn/tjsj/tjzs/index.html";
			charset = "utf-8";
			selector = ".larightcon li";
			selector02 = ".TRS_Editor img[src]";
			selector03 = ".xxgk-xl-text";

			filepath = "G:\\数据\\宁夏\\地级市\\银川\\222的方式的方式\\";
								...
								for (int j = 0; j < imgList.size(); j++) {
									...
									if (j == 0) {
										...
										CrawlerUtil.downloadFromHtml(
												filepath + releaseDate + "\\" + name + picIndex + ".png",
												imgList.get(j));
									} else {
										picIndex = (j + 1) + "";
										CrawlerUtil.downloadFromHtml(
