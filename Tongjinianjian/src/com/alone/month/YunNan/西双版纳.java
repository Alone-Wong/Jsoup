...
public class 西双版纳 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 2; i++) {
			number = i + "";
			url = "http://www.yndali.gov.cn/index.php?m=content&c=index&a=lists&catid=89&page=4";
			charset = "utf-8";
			htmlselector = ".list-cont ul li a[href]";
			htmlSelector02 = "body > div.show.gov.clearfix > div.content.clearfix > p";
			...
			for (Element element : eles) {
				...
				if (href != null && !"".equals(href) && !href.contains("?page=")) {
