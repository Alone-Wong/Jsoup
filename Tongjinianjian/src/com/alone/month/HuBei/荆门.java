...
public class 荆门 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 2; i < 5; i++) {
			number = i + "";
			url = "http://jmtjj.jingmen.gov.cn/tjsj/index_"+number+".html";
			charset = "gb2312";
			selector = "body > table:nth-child(2) > tbody > tr > td:nth-child(2) > table:nth-child(2) > tbody > tr:nth-child(2) > td > table:nth-child(1) > tbody tr";
