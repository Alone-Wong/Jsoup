...
public class 毕节3 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i < 2; i++) {
            ...
            url = "http://www.hbqj.gov.cn/tjxxsjfx/20150727/19169.html";
            charset = "utf-8";
            selector = ".detail-article.font16";
            filepath = "G:\\数据\\统计年鉴\\湖北\\潜江\\2014年潜江市经济和社会发展统计公报\\";
            CrawlerUtil.dirCheck(filepath);

            // 抓取页面数据
            Document doc = CrawlerUtil.getFromHtml02(url, charset);
            String title = "2014年潜江市经济和社会发展统计公报";
