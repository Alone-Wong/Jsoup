...
public class 荆州 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 4; i++) {
			number = i + "";
			url = "http://www.jingzhouqu.gov.cn/list/tongjixinxizw-"+number+".html";
			charset = "utf-8";
			selector = ".line a[href]";
			selector02 = ".ke-insertfile";
			selector03 = "body > div > table.table1b > tbody > tr > td > table tbody";

			filepath = "G:\\数据\\湖北\\地级市\\荆州\\";
			...
			for (Element element : elements) {
				...
				String releaseDate = "";
				// String releaseDate =
				// element.select("time").text().substring(0, 4);
				...
				if (link != null && !"".equals(link)) {
					 ...
					 */
						...
						if (htmlElements.size() != 0 && !htmlElements.isEmpty()) {
							...
							CrawlerUtil.downloadFromHtml(filepath + releaseDate + "\\" + name + ".xls", picUrl);
						}
						/**
						 * 文字 文字,图片混合
						 */
