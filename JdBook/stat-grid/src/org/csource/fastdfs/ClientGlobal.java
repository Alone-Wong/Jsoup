...
*/
	...
	public static void init(String connect_timeout, String network_timeout, String charset, String tracker_http_port,
			String anti_steal_token, String secret_key, String tracker_server) throws FileNotFoundException, IOException, MyException
	{
  		String[] szTrackerServers;
			String[] parts;
...
//			g_connect_timeout = iniReader.getIntValue("connect_timeout", DEFAULT_CONNECT_TIMEOUT);
			g_connect_timeout = Integer.parseInt(connect_timeout);
  		if (g_connect_timeout < 0)
  		{
  			g_connect_timeout = DEFAULT_CONNECT_TIMEOUT;
  		}
  		...
  		g_network_timeout = Integer.parseInt(network_timeout);
  		if (g_network_timeout < 0)
  		{
  			g_network_timeout = DEFAULT_NETWORK_TIMEOUT;
  		}
  		...
  		g_tracker_http_port = Integer.parseInt(tracker_http_port);
  		g_anti_steal_token = anti_steal_token.equalsIgnoreCase("yes")||anti_steal_token.equalsIgnoreCase("on")
  				||anti_steal_token.equalsIgnoreCase("true")||anti_steal_token.equalsIgnoreCase("1");
  		if (g_anti_steal_token)
  		{
