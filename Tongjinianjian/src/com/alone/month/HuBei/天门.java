...
public class 天门 {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < 12; i++) {
			...
			number = i + "";
			url = "http://www.tianmen.gov.cn/root10/0000/auto952/list_" + number + ".shtml";
			charset = "utf-8";
			selector = ".tmxxgk_mainform table tr:has(a[href])";
			selector02 = ".am-article-bd abc";
			selector03 = ".editor";

			filepath = "G:\\数据\\湖北\\地级市\\天门\\";
			...
			for (Element element : elements) {
				String releaseDate = element.select(".xxgk_form2").text().substring(0, 4);
				// 获取链接绝对地址
